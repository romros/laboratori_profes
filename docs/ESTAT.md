...
- **`question-answer-extraction`:** implementació (després de tancar decisions tècniques del MVP; veure doc §13).
...
Segons prioritat de PM: **Feature 0** (coordenades reals / layout) **o** primera tasca d’implementació de **`question-answer-extraction`** (contracte a `domain/`, OCR, etc.). Validació habitual: `./scripts/run_frontend.sh …` (Docker).
